...
- 🎯 Entry points to execute your program using `python -m <simple_vllm>` or `$ simple_vllm` with basic CLI argument parsing.
...
Awesome simple_vllm created by minturtle
